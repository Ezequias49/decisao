programa
{
    funcao inicio()
    {
        ...
        se (opcao == 2)
        {
            escreva("Digite o número de processos (máximo 15): ")
            leia(num_processos)
    ...
    funcao roundRobin(cadeia nomes[], inteiro tempos_uso[], inteiro tempos_chegada[], inteiro num_processos, inteiro quantum)
    {
        ...
        enquanto (existeProcessoNaoFinalizado(tempos_restantes, num_processos))
        {
            ...
            se (num_na_fila > 0)
            {
                ...
                escreva("Tempo ", tempo_atual, ": Processo ", nomes[processo_atual], " está na CPU\n")
                ...
                // Recoloca o processo na fila se ele não terminou
